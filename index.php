...
<div class="container-fluid">
    <a class="navbar-brand" href="#">Tienda John</a>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="precio" type="hidden" id="precio" value="2500" />
        ...
        <img src="img/moto.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        ...
                        <p class="card-text">Descripción - Precio 2500€</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/lambo.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Lamborghini </h5>
                        <p class="card-text">Descripción - Precio 10000€</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/cel.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Samsung A12 </h5>
                        <p class="card-text">Descripción - Precio 250</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
